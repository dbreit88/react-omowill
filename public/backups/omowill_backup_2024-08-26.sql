...
CREATE TABLE `update_data` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=363 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `user_estate_pdf` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=44 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user_make_will` VALUES (5,5,0,'1724703706555.pdf','1724711818424.pdf',NULL,'2024-08-26 20:02:38'),(6,6,0,'','1724706821869.pdf',NULL,'2024-08-26 21:13:43'),(7,7,0,'','',NULL,'2024-07-17 00:02:36');
...
INSERT INTO `user_will_content` VALUES (4,'1724695745539.pdf','1123'),(5,'1724702557750.pdf','123552'),(6,'1724706821869.pdf','123123'),(7,'1724707946058.pdf','123'),(8,'1724708310653.pdf','123'),(9,'1724711818424.pdf','2456');
...
-- Dump completed on 2024-08-27  7:46:04
