...
const createTables = async () => {
    try {
        ...
        const estateTable = `
        CREATE TABLE IF NOT EXISTS user_estate_pdf  (
            'id' int NOT NULL AUTO_INCREMENT PRIMARY KEY,
            'pdf_name' varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
            'reg_num' varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
            'location' varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
            'prop_type' varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
            'owner' varbinary(255) NULL DEFAULT NULL,
            'address' varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
            'land_category' varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
            'area' int NULL DEFAULT NULL,
            'acq_date' timestamp NULL DEFAULT NULL,
            'reg_right' varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
            'prev_owner' varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
            'boundary_detail' varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
            'usage_right' varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
            'other_right' varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
            'restriction' varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
            'shared_prop' varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
            'own_ratio' int NULL DEFAULT NULL,
            'co_owner' varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
